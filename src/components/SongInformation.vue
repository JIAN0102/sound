...
<template>
  <div
    class="rel square max-w:400 mx:auto overflow:hidden r:10"
    :class="{
  ...
  <div class="flex ai:flex-start gap-x:20 mt:30">
    ...
    >
      ...
      ></div>
      <div class="rel">
        <IconPause v-if="song.docID === currentSong.docID && isSoundPlaying" />
        <IconPlay v-else />
      </div>
    </button>
  </div>
