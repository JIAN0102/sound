...
<template>
  ...
  <button
    class="group rel w:full mt:20 rounded bg:primary mt:30@md @backgroundGradient|2s|linear|infinite:hover@md"
    type="button"
  ...
  >
    ...
    <div class="rel flex center-content h:60">
      ...
      <h4 class="f:bold">
        <template v-if="song.uuid === currentSong.uuid && isSoundPlaying"
          >暫停</template
        >
