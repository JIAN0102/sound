...
<template>
  <div
    class="fixed inset:0 z:9999 overflow-x:hidden overflow-y:auto pointer-events:none bg:repeating-linear-gradient(40deg,#19191e,#19191e|3px,white/.1|3px,white/.1|8px) bd:blur(5) opacity:0 invisible ~opacity|.3s,visibility|.3s {pointer-events:auto;opacity:1;visible}.is-open"
    ...
    >
      <div class="rel w:full bg:black r:60 pointer-events:auto">
        ...
        <div class="p:40 bg:#333 b:10|solid|black r:60">
          <VForm v-show="type === 'login'" @submit="login">
            <div>
              <label class="f:bold f:18 fg:white" for="loginEmail"
                >電子郵件</label
              >
              <VField
                id="loginEmail"
            ...
            <div class="mt:20">
              <label class="f:bold f:18 fg:white" for="loginPassword"
                >密碼</label
              >
              <VField
                id="loginPassword"
          ...
          <VForm v-show="type === 'register'" @submit="register">
            <div>
            ...
            <div class="mt:20">
              <label class="f:bold f:18 fg:white" for="registerPassword"
                >密碼</label
              >
              <VField
                id="registerPassword"
